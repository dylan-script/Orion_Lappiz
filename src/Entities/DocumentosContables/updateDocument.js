setTimeout(() => {
  $("#actualizar").click(function () {
    ...
    let prefijo = getFieldValue('ab254777-79a8-4a3f-bc0c-8f3c0b25a3c9');
    var StringQuery = `UPDATE Orion_Lappiz_DocumentoContable SET NumeracionInicialDoc = '${numeroInicial}', TipoDocumentoCont = '${tipoDocumento}', PrefijoDocumentoCont = '${prefijo}' WHERE IdCopropiedadFK = '${sessionStorage.CopropiedadId}' AND NombreDocumentoCont = '${nombreDocumento}'`;
